...
;(function () {
  ...
  function jsonToCsv (options, callback) {
    ...
    if (options.delimiter) {
      json2csvOptions.delimiter = {
        field: options.delimiter
      }
      console.log('json2csv options: ' + JSON.stringify(json2csvOptions))
    }

    return converter.json2csv(options.dataSet, callback, json2csvOptions)
  }
})()
